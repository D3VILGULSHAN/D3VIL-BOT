...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "D3VILBOT/elevated_users.json")
...
# *Global Blue Text*
#  ❍ /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across D3VILBOT.
